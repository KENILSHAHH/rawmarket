...
export function TradingTerminal(){
  ...
  return <main className="app-shell">
    ...
    <PortfolioDock tab={terminal.dockTab} onTab={terminal.setDockTab} account={terminal.account} openOrders={terminal.openOrders} fills={terminal.fills} wallet={terminal.wallet} symbol={terminal.symbol} position={terminal.position} onCancel={id=>void terminal.cancelOrder(id)}/>
